export const letterG = {
  nouns: [
    ...
    {"birth year": ["Geburtsjahr", "Geburtsjahre", "das", "die", "n"]},
    {"birthplace": ["Geburtsort", "Geburtsorte", "der", "die", "m"]},
    {"birthday": ["Geburtstag", "Geburtstage", "der", "die", "m"]},
    {"money": ["Geld", "Gelder", "das", "die", "n"]},
    {"vegetables": ["Gemüse", "Gemüse", "das", "die", "n"]},
    {"luggage": ["Gepäck", "Gepäck", "das", "das", "n"]},
    {"store, shop": ["Geschäft", "Geschäfte", "das", "die", "n"]},
    {"gift, present": ["Geschenk", "Geschenke", "das", "die", "n"]},
    {"siblings": ["Geschwister", "Geschwister", "die", "die", "p"]},
    {"conversation": ["Gespräch", "Gespräche", "das", "die", "n"]},
    {"drink": ["Getränk", "Getränke", "das", "die", "n"]},
    {"weight": ["Gewicht", "Gewichte", "das", "die", "n"]},
    {"glass": ["Glas", "Gläser", "das", "die", "n"]},
    {"track (railway)": ["Gleis", "Gleise", "das", "die", "n"]},
    {"luck": ["Glück", "Glücke", "das", "die", "n"]},
    {"congratulations": ["Glückwunsch", "Glückwünsche", "der", "die", "m"]},
    {"degree Celsius": ["Grad", "Grade", "der", "die", "m"]},
    {"size": ["Größe", "Größen", "die", "die", "f"]},
    {"grandparents": ["Großeltern", "Großeltern", "die", "die", "p"]},
    {"grandmother": ["Großmutter", "Großmütter", "die", "die", "f"]},
    {"grandfather": ["Großvater", "Großväter", "der", "die", "m"]},
    {"group": ["Gruppe", "Gruppen", "die", "die", "f"]},
    {"greeting": ["Gruß", "Grüße", "der", "die", "m"]},
    {"reason": ["Grund", "Gründe", "der", "die", "m"]}
  ],
  verbs: [
    {"to give": ["geben", "gebe", "gibst", "gibt", "gibt", "gibt", "geben", "gebt", "geben", "geben"]},
    {"to be pleasing": ["gefallen", "gefälle", "gefälst", "gefällt", "gefällt", "gefällt", "gefallen", "gefallt", "gefallen", "gefallen"]},
    {"to go": ["gehen", "gehe", "gehst", "geht", "geht", "geht", "gehen", "geht", "gehen", "gehen"]},
    {"to belong to": ["gehören", "gehöre", "gehörst", "gehört", "gehört", "gehört", "gehören", "gehört", "gehören", "gehören"]},
    {"to win": ["gewinnen", "gewinne", "gewinnst", "gewinnt", "gewinnt", "gewinnt", "gewinnen", "gewinnt", "gewinnen", "gewinnen"]},
    {"to believe": ["glauben", "glaube", "glaubst", "glaubt", "glaubt", "glaubt", "glauben", "glaubt", "glauben", "glauben"]},
    {"to congratulate": ["gratulieren", "gratuliere", "gratulierst", "gratuliert", "gratuliert", "gratuliert", "gratulieren", "gratuliert", "gratulieren", "gratulieren"]},
    {"to grill": ["grillen", "grille", "grillst", "grillt", "grillt", "grillt", "grillen", "grillt", "grillen", "grillen"]},
